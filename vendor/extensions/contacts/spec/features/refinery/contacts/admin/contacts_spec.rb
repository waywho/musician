    ...
    describe "Admin" do
      describe "contacts", type: :feature do
        ...
        describe "contacts list" do
          before do
            FactoryGirl.create(:contact, :first_name => "UniqueTitleOne")
            FactoryGirl.create(:contact, :first_name => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:contact, :first_name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:contact, :first_name => "A first_name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:contact, :first_name => "UniqueTitleOne") }

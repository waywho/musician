...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "373318523c88bd67c145d1b4bbfd8e346712965fe21f1bd9"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/vagrant/src/musician/public/system/refinery/resources"
